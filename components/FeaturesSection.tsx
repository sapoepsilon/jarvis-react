  ...
  return (
    <section id="features" className="h-screen w-full bg-black">
      <div className="flex flex-grow flex-col w-full items-center bg-opacity-0 pt-16 mb-6 rounded-b-[40px] pb-10 bg-transparent">
        <div className="pt-6 flex flex-col items-center justify-center mt-10 mb-60 bg-transparent">
        ...
        <p className={`absolute text-center lg:text-6xl md:text-5xl text-3xl font-bold text-white bg-clip-text opacity-80 top-1/2 left-1/2 transform -translate-x-1/2 ${isInView ? "-translate-y-80" : "-translate-y-100"} transition-all duration-700 ease-in-out z-10`}>
  Manage your client base with Chat genie
</p>
        <div id="animatedTextSection" className="relative bg-transparent">


          <div className="flex flex-col md:flex-row items-center justify-center space-x-0 md:space-x-10 space-y-10 md:space-y-0 bg-transparent">
